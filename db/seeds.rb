...
admin_usr = User.create(role: rol_admin, client: client1,
                        ...
                        full_name:'Martin Cabrera', email:'cabrera@gmail.com')
...
client_usr = User.create(role: rol_client, client: client1,
                         ...
                         full_name:'Bill Gates', email:'gates@gmail.com')
